...
baixada para o seu computador pela tela **Cópia dos dados**, e volta pela mesma tela; os
arquivos enviados saem da nuvem 7 dias depois de processados (ADR 0016 e 0017).
