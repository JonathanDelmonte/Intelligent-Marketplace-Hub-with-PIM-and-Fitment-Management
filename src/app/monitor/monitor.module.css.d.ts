/**
 * Tipos das classes de `monitor.module.css`. Escrito à mão pelo mesmo motivo dos
...
declare const estilo: {
  ...
  readonly itemAlerta: string;
  readonly itemAtencao: string;
  readonly itemCabecalho: string;
  readonly itemCorpo: string;
  readonly itemOk: string;
  ...
  readonly mudancaQuando: string;
  readonly mudancaSignifica: string;
  readonly mudancaTitulo: string;
  readonly mudancas: string;
