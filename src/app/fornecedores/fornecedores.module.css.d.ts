/**
 * Tipos das classes de `fornecedores.module.css`, escritos à mão pelo mesmo motivo
 * dos outros módulos de estilo: a declaração injetada é assinatura de índice, e
 * nome de classe errado compilaria.
 */
